...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--end_early", default=False, type=bool, help="end early"
    )
    ...
    # net.load_state_dict(
    #     torch.load("/userhome/train/checkpoint/resnet104/600/0.6/ImageNet_T=1ACC/Thursday_14_April_2022_00h_10m_47s/resnet104-148-best.pth", map_location=map_location))
    ...
    train_scheduler = optim.lr_scheduler.CosineAnnealingLR(
        optimizer, T_max=settings.EPOCH//5, eta_min=0, last_epoch=0
    )
